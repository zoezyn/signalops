...
import client from './api/getClient';



const gptWebSearch = async (setLoading) => {
  setLoading(true);
  ...
  console.log("Annotations:", response.output?.[1]?.content?.[0]?.annotations);
...
export default function Home() {
  ...
  useEffect(() => {
    gptWebSearch(setLoading).then(setSearchResult);
  }, []);
  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <div className="mb-8 max-w-250">
          {loading ? <LoadingIcon /> : searchResult}
        </div>
